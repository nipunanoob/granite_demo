...
class User < ApplicationRecord
  ...
  before_save :to_lowercase # before saving, change email to lowercase
  before_destroy :assign_tasks_to_task_owners # before removing user, assign all tasks under user to task owner
